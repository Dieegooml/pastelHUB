...
const VALID_TYPES = ['order_update', 'new_review', 'shop_approved', 'shop_rejected', 'shop_suspended', 'report_resolved', 'new_order', 'payment_confirmed', 'review_approved', 'review_rejected'];
